 ...
 */
Queen::Queen(const int row, const int col, const bool is_white):
 ...
 * It's only check if the move is diagonal, horizontal or vertical.
 * @param target_row The target row to move to
 * @param target_col The target column to move to
 * @return true if the move is valid, false otherwise
 */
bool Queen::isValidMove(const int target_row, const int target_col) {
